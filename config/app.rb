...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'vzero-demo.com'
  config.app_name = 'Vzero-demo'
  config.mailer.from = 'Vzero-demo <no-reply@vzero-demo.com>'
  ...
  #
  config.app_secret = 'tSl1ge9FfgUKRNJS8NefST3kZVwL3kcENvaGwoD0FJQ1EcC7Bevc-yQV8Ni6q_xQVjs'
